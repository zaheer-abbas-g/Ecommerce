        ...
        <form id='productForm' name="productForm" method="post" id="myDropzone" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control" value="<?php echo e($product->slug); ?>" placeholder="Slug" readonly>	
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" id="short_description" cols="30" rows="10" class="summernote" placeholder="short_description"><?php echo e($product->short_description); ?></textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="10" class="summernote" placeholder="Description"><?php echo e($product->description); ?></textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="shipping_return" id="shipping_return" cols="30" rows="10" class="summernote" placeholder="shipping_return"><?php echo e($product->shipping_return); ?></textarea>
                                    </div>
                                </div> 
                            ...
                            <table>
                                <tr>
                                    <?php if(!empty($productImage)): ?>
                                        <?php $__currentLoopData = $productImage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td>
                                            <div class="card" style="height:150px; width:200px;margin:5px">
                                                <div >
                                                    <img src="<?php echo e(asset('productimages/'.$item->image)); ?>" style="height:150px; width:200px;margin:5px">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <input type="hidden" value="<?php echo e($product->id); ?>" name="pr_id" id="pr_id">							
                            <h2 class="h4 mb-3">Pricing</h2>	
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="price">Price</label>
                                        <input type="number" name="price" id="price" class="form-control" value="<?php echo e($product->price); ?>" placeholder="Price">	
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="compare_price" id="compare_price" class="form-control" value="<?php echo e($product->compare_price); ?>" placeholder="Compare Price">
                                    </div>
                                </div>                                            
                            </div>
                        </div>	                                                                      
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="sku" id="sku" class="form-control" value="<?php echo e($product->sku); ?>" placeholder="sku">	
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="barcode" id="barcode" class="form-control" value="<?php echo e($product->barcode); ?>" placeholder="Barcode">	
                                    </div>
                                </div>   
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <?php echo e(($product->track_quantity == 'Yes')? 'chacked' : ''); ?> checked>
                                            <label for="track_qty" class="custom-control-label">Track Quantity</label>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <input type="number" min="0" name="qty" id="qty" class="form-control" value="<?php echo e($product->quantity); ?>" placeholder="Qty">	
                        ...
                        <div class="card-body">	
                            ...
                            <div class="mb-3">
                                ...
                                <select name="sub_category" id="sub_category" class="form-control" readonly>
                                    <option value="" selected disabled>select</option>
                                <?php if(!empty($subCategories_edit)): ?>
                                    <?php $__currentLoopData = $subCategories_edit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subCategories->id); ?>" <?php echo e(($subCategories->id==$product->sub_category_id)? 'selected':''); ?>><?php echo e($subCategories->name); ?></option>   
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?> 
                                    </select>
                            </div>
                                ...
                                <select name="brand" id="brand" class="form-control">
                                    ...
                                    <?php if(!empty($brand)): ?>
                                        <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brnd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($brnd->id); ?>" <?php echo e(($product->brand_id== $brnd->id)? 'selected' : ''); ?>><?php echo e($brnd->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>                                
                                </select>
                            </div>
...
<script>
    ...
    ajax: {
            url: '<?php echo e(route("get.products")); ?>',
            dataType: 'json',
            tags: true,
            multiple: true,
        ...
        $('#productbtn').on('click',function(e){
            ...
            $.ajax({
                url:"<?php echo e(url('admin/product-update')); ?>",
                type:"post",
                data:formData,
                dataType:"json",
                processData:false,
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce\resources\views/admin/product/product_edit.blade.php ENDPATH**/ ?>
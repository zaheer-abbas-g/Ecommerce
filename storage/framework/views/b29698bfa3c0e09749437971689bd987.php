		...
		<div class="wrapper">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
							<img src="<?php echo e(asset('images/'.auth()->user()->image)); ?>" class='img-circle elevation-2' width="40" height="40" alt="">
						</a>
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							...
							<a class="dropdown-item" href="<?php echo e(route('logout')); ?>" class="dropdown-item text-danger"
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<a href="<?php echo e(url('/')); ?>" class="brand-link">
					<img src="<?php echo e(asset('admin_assets/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/category')); ?>" class="nav-link">
									<i class="nav-icon fas fa-file-alt"></i>
									<p>Category</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/sub-category')); ?>" class="nav-link">
									<i class="nav-icon fas fa-file-alt"></i>
									<p>Sub Category</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/brands')); ?>" class="nav-link">
							...
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/orders')); ?>" class="nav-link">
									<i class="nav-icon fas fa-shopping-bag"></i>
									<p>Orders</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/discount')); ?>" class="nav-link">
									<i class="nav-icon  fa fa-percent" aria-hidden="true"></i>
									<p>Discount</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/users')); ?>" class="nav-link">
									<i class="nav-icon  fas fa-users"></i>
									<p>Users</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(asset('admin/pages')); ?>" class="nav-link">
...
</html><?php /**PATH D:\xampp\htdocs\YahooEcommerce\Ecommerce\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>
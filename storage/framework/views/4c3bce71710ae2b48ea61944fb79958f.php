                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="shipping_return" id="shipping_return" cols="30" rows="10" class="summernote" placeholder="shipping_return"></textarea>
                                    </div>
                                </div>                                            
                            </div>
                        </div>	                                                                      
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce\resources\views/admin/product/create_products.blade.php ENDPATH**/ ?>
        ...
        <div class="row pb-3">
            ...
            <div class="col-lg-3">            
                <div class="cat-card" style="height: 50%">
                    <div class="left"  >
                        @if ($category->image !="")
                            <img src="{{asset('/images/'.$category->image)}}" alt=""  class="img-fluid" style="height: 100%">
                        @endif
                    </div>
                    <div class="right" >
                        <div class="cat-data">
        ...
        <div class="row pb-3">
            @if (count($latestproducts)>0)
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            @if ($latestproduct->product_images->isNotEmpty())
                                    @foreach ($latestproduct->product_images as $value)
                                    <a href="" class="product-img"><img class="card-img-top" src="{{asset('/productimages/'.$value->image)}}" alt=""></a>
                                    @endforeach
                            @endif
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
